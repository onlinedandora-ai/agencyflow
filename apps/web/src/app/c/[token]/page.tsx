          ...
          {billing.draftInvoice && (
            <div className="glass-panel p-6">
              <div className="flex flex-wrap items-center justify-between gap-4">
                ...
                <a href={`/d/${billing.draftInvoice.publicToken}?print=1`} target="_blank" rel="noreferrer" className={buttonVariants()}>
          ...
          {billing.taxInvoice && (
            <div className="glass-panel p-6">
              <div className="flex flex-wrap items-center justify-between gap-4">
                ...
                <a href={`/d/${billing.taxInvoice.publicToken}?print=1`} target="_blank" rel="noreferrer" className={buttonVariants({ variant: "outline" })}>
            ...
            <div className="space-y-3">
              ...
              {billing.receipts.map((receipt) => (
                <div key={receipt.id} className="glass-panel flex items-center justify-between p-4">
                  ...
                  <a href={`/d/${receipt.publicToken}?print=1`} target="_blank" rel="noreferrer" className="text-sm text-primary">
                    Download receipt
                  </a>
                </div>
              ))}
